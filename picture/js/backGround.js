/**
 * Created by MAIBENBEN on 2018/5/15.
 */
//移动至导航的，三角形移动功能
...
for(var i=0;i<lis.length;i++){
  ...
  lis[i].style.backgroundSize=490+"px";
  //lis[i].style.backgroundRepeat="no repeat";
};
...
$(function () {
  ...
  //拖拽图片
  var spacx=0
  $(".zhang").mousedown(function (e) {
    spacx= e.pageX;
    var current=parseInt(window.getComputedStyle($(".zhang")[0]).left);
    $('.zhang').mousemove(function (e) {
    var mousespace=spacx-e.pageX;
      $('.zhang .uls').css({left:current-mousespace});
    })
  })
  $(".zhang").mouseup(function (e) {
    var mousup= e.pageX;
