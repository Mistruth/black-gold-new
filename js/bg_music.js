...
function creatList() {
  var data = [
    { title: 'YouMeanEveryThingToMe', singer: '侯明昊', duration: '03:30' },
    { title: 'THANK YOU 谢你', singer: '曾舜晞', duration: '03:30' },
    { title: 'Blue Maze', singer: '尚雯婕', duration: '05:37' },
    { title: 'The One That Ran Away', singer: '尚雯婕', duration: '03:35' },
    { title: '乐园', singer: '曾舜晞', duration: '03:36' },
    { title: '时光沧海', singer: '迪玛希', duration: '04:30' }
  ];
  var ul = document.querySelector('.music_list ul');
  var li_first = document.querySelector('.music_list ul li');
  for (var i = 0; i < data.length; i++) {
    var li = li_first.cloneNode(true);
    var title = li.querySelectorAll('.item_title p')[0];
    var singer = li.querySelectorAll('.item_title p')[1];
    var duration = li.querySelectorAll('.timer span')[2];
    title.innerText = data[i].title;
    singer.innerText = data[i].singer;
